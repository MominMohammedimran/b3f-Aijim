    ...
    try {
      ...
      const { error } = await supabase
        ...
        .insert({
          ...
          reward_points_earned: orderData.reward_points_earned,
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <Select value={orderData.user_id} onValueChange={(value) => setOrderData(prev => ({ ...prev, user_id: value }))}>
              <SelectTrigger>
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <Input
                ...
                onChange={(e) => setOrderData(prev => ({
                  ...prev,
                  shipping_address: { ...prev.shipping_address, email: e.target.value }
                }))}
              />
              <Input
                placeholder="City"
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <Input
                ...
                onChange={(e) => setOrderData(prev => ({ ...prev, delivery_fee: parseInt(e.target.value) || 0 }))}
              />
            </div>
            <div>
              ...
              <Input
                ...
                onChange={(e) => setOrderData(prev => ({ ...prev, reward_points_earned: parseInt(e.target.value) || 0 }))}
              />
            </div>
          </div>
