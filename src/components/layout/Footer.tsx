    ...
    <footer className="bg-black text-gray-300 border-t border-gray-800 mt-10 pb-24 sm:pb-12">
      ...
      <div className="max-w-full text-center mt-10">
        ...
        <p className="text-sm p-1 text-gray-400 font-medium leading-relaxed max-w-90 mx-auto">
          {loading ? 'Loading...' : settings?.site_description || 'Default description if not set'}
        </p>
        ...
        <p className="text-xs md:text-md lg:text-md text-gray-200 font-medium">
          ...
          <span className="font-semibold text-white">{settings?.site_name || 'AIJIM Clothing'}</span> ® —
