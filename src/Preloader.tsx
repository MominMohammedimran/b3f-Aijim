...
export default function Preloader({ onComplete }: { onComplete: () => void }) {
  const parts = [
    { id: "down", clip: "inset(0 0 74% 0)", anim: { y: [ 0, 0 ] } }, // top 20%
    { id: "up", clip: "inset(18% 0 50% 0)", anim: { y: [ 0, 0 ] } },  // 2nd 20%
    { id: "left", clip: "inset(32% 0 30% 0)", anim: { x: [ 0, 0 ] } }, // 3rd 20%
    { id: "right", clip: "inset(54% 0 10% 0)", anim: { x: [ 0, 0 ] } }, // 4th 20%
    ];
