...
async function fetchProductsOnce(): Promise<Product[]> {
  ...
  _products = (data || []).map((p: any) => ({
    ...
    additionalImages: Array.isArray(p.additional_images)
      ? p.additional_images.map(String)
      : [],
    rating: p.rating ?? 0,
    category: p.category || "",
    ...
    seo_keywords: Array.isArray(p.seo_keywords)
      ? p.seo_keywords.map(String)
      : [],
...
export const categories: Category[] = [
  {
    ...
    name: "T-Shirt Print",
    image:
      "https://cmpggiyuiattqjmddcac.supabase.co/storage/v1/object/public/product-images/hero-categorie/tshirt-print.webp",
  },
  {
    id: "2",
    name: "Mug Print",
    image:
      "https://cmpggiyuiattqjmddcac.supabase.co/storage/v1/object/public/product-images/hero-categorie/mug-print.webp",
  },
  {
    id: "3",
    name: "Cap Print",
    image:
      "https://cmpggiyuiattqjmddcac.supabase.co/storage/v1/object/public/product-images/hero-categorie/cap-print.webp",
  },
  {
    id: "4",
    name: "Photo print",
