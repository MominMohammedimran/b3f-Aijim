I will share productcard and products see how it works then update the products.tsx
...
src={img}
alt={product.name}
className={absolute inset-0 w-full h-full object-cover transition-opacity duration-700 ${   i === currentImage ? "opacity-100" : "opacity-0"   } group-hover:scale-[1.03]}
/>
))}
