      ...
      <div className="min-h-screen bg-background">
        <div className="container-custom pt-16 pb-8">
          <div className="flex items-center mb-8">
            ...
            <div>
              <h1 className="text-4xl font-black text-foreground tracking-tight">CONTACT US</h1>
        ...
        <div className="container-custom">
          <div className="grid lg:grid-cols-2 gap-12">
            <div className="space-y-8">
              <div>
                <h2 className="text-2xl font-black text-foreground mb-6 uppercase tracking-wide">
                  GET IN TOUCH
                </h2>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-foreground font-bold mb-1">{contact.primary}</p>
                          <p className="text-muted-foreground mb-2">{contact.secondary}</p>
