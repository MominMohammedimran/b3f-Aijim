            ...
            try {
              ...
              if (Array.isArray(raw)) {
                return raw
                  .filter(
                    (v): v is any =>
                      v && typeof v === "object" && "size" in v && "stock" in v
                  )
                  .map((v) => ({
                    size: String(v.size),
  ...
  const ProductForm = ({ isEdit }: { isEdit: boolean }) => (
    <div className="space-y-4 max-h-96 overflow-y-auto">
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label htmlFor={isEdit ? "name" : "add-name"} className="text-white">
            Product Name
          </Label>
          <Input
        ...
        <div>
          <Label htmlFor={isEdit ? "code" : "add-code"} className="text-white">
            Product Code
          </Label>
          <Input
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <Label
            htmlFor={isEdit ? "price" : "add-price"}
        ...
        <div>
          <Label
            htmlFor={isEdit ? "stock" : "add-stock"}
            className="text-white"
          >
            Stock
          </Label>
      ...
      <div>
        <Label
          htmlFor={isEdit ? "category" : "add-category"}
          className="text-white"
        >
          Category
        </Label>
      ...
      <div>
        <Label
          htmlFor={isEdit ? "description" : "add-description"}
          className="text-white"
        >
          Description
        </Label>
      ...
      <div>
        <Label htmlFor={isEdit ? "image" : "add-image"} className="text-white">
          Main Image URL
        </Label>
        <Input
      ...
      <div>
        ...
        <div className="space-y-2">
          {formData.images.map((url, index) => (
            <div
              key={index}
              className="flex items-center gap-2 p-2 bg-gray-700 text-white"
            >
