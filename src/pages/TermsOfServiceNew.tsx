              ...
              <div className="bg-card border border-border rounded-lg shadow-glow">
                ...
                <section id="account" className="p-8 border-b border-border">
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <p className="font-medium text-foreground">Account termination may occur if these terms are violated.</p>
                  </div>
                </section>
                ...
                <section id="orders" className="p-8 border-b border-border">
                  <div className="flex items-center mb-6">
                    <ShoppingBag className="text-accent mr-3" size={28} />
                ...
                <section id="payments" className="p-8 border-b border-border">
                  <div className="flex items-center mb-6">
                    <CreditCard className="text-accent mr-3" size={28} />
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="bg-muted border border-border rounded-lg p-4 mt-4">
                      ...
                      <p className="text-sm">We use industry-standard encryption to protect your payment information.</p>
                    </div>
                  </div>
                </section>
                ...
                <section id="legal" className="p-8 border-b border-border">
                  <div className="flex items-center mb-6">
                    <Scale className="text-accent mr-3" size={28} />
                  ...
                  <div className="space-y-4 text-muted-foreground leading-relaxed">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-6">
                      <div className="bg-muted border border-border rounded-lg p-4">
                        ...
                        <p className="text-sm">AIJIM's liability is limited to the amount paid for the specific product or service.</p>
                      </div>
                      <div className="bg-muted border border-border rounded-lg p-4">
                        <h4 className="font-semibold text-foreground mb-2">Indemnification</h4>
                        <p className="text-sm">Users agree to indemnify AIJIM against claims arising from their use of our services.</p>
                      </div>
                    </div>
                  </div>
                </section>
